...
import { isValidDate, isValidEmail } from "@/utils/valid-checker";
    ...
    <>
      ...
      <div className="w-full relative flex flex-wrap gap-2">
        ...
        <div className="w-full text-lg font-bold">
          {isValid === true ? (
            <span className="text-blue-500">예, 날짜 형식이 맞습니다.</span>
          ) : null}
          {isValid === false ? (
            <span className="text-red-500">아니오, 날짜 형식이 아닙니다.</span>
          ) : null}
        </div>
      </div>
    </>
